...
```
```{r}
# Selektiere Spalten Datum und IstFeiertag

feiertage<-feiertage_neu %>%
  select (Datum, istFeiertag)
```

<<<<<<< HEAD
```{r}
#In Datensatz schreiben als csv
write.csv(feiertage, 'feiertage.csv', row.names = TRUE)
```

=======
>>>>>>> 22d7a8742f66d8b63e6e9f3af9ccf102f0931502
