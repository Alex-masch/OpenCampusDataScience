...
```{r}
#ToDo: Mit pivot_longer-Befehl Spalten reduzieren und Datensatz in die Struktur Datum/Feiertage umwandeln, wobei Feiertage in der Tabelle binär codiert wird
```
