...
data<-umsatzdaten_kiwo_wetter_feiertage
...
#Aufnahme Feiertage (erzeugt bei mir einen contrast-Fehler. Weil Feiertage nur zwei Werte hat und deshalb kaum Vorhersage-Qualität?)
#M7<-update(M6,.~.+istFeiertag)
#model_M7 <- lm(M7,data,na.action=na.exclude)
#summary(model_M7)
#Interpretation: 
...
model_final <- lm(Mfinal,data,na.action=na.exclude)
summary(model_final)
