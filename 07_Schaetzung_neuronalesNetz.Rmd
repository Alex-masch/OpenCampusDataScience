...
### Installation von Python und TensorFlow (nur einmalig nötig, wer es noch installieren muss, bitte die Auskommentierungen entfernen)
```{r}
...
```{r, include=FALSE}
source("06_Datenaufbereitung_neuronalesNetz.Rmd")
```
...
```{r}
## Grafischer vergleich der vorhergesagten und der tatsächlichen Umsätze für die Trainings- und Testdaten
