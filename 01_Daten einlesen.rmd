...
umsatzdaten_kiwo_wetter_feiertage<-left_join(umsatzdaten_kiwo_wetter , feiertage, by="Datum")
...
write.csv(umsatzdaten_kiwo_wetter,file.path('Daten','umsatzdaten_kiwo_wetter_feiertage.csv',fsep = .Platform$file.sep))
