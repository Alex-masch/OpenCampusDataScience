...
Vorhersage_lm <- predict(object=model_M4, newdata = Vorhersagedaten_kiwo_wetter, type = "response", interval = "confidence", na.action = na.exclude)
...
Vorhersagedaten_kiwo_wetter_mit_Vorhersage_lm <- dplyr::bind_cols(Vorhersagedaten_kiwo_wetter, as.data.frame(Vorhersage_lm)) #in dieser Datei sind "fit" die Umsatz-Prädiktionen für die jeweiligen Datenpunkte, lwr und upr sind die Grenzen der Konfidenzintervalle
 ...
 Vorhersagedaten_kiwo_wetter_mit_Vorhersage_lm<- rename(Vorhersagedaten_kiwo_wetter_mit_Vorhersage_lm,VorUmsatz = fit,UntereGrenzeKonfInt=lwr,ObereGrenzeKonfInt=upr)
...
```
=======
>>>>>>> 4b520530a5bb6f268599ce2cb0a2ae5816424c47
